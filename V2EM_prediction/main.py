...
if __name__ == "__main__":
    ...
    sys.argv = ['main.py', '-lr=4.5e-6', '-ep=40', '-mod=tav', '-bs=1','--img-interval=100', '--early-stop=6', '--loss=bce', '--cuda=0', '--model=mme2e', '--num-emotions=6','--trans-dim=64', '--trans-nlayers=4', '--trans-nheads=4', '--text-lr-factor=10', '--text-model-size=base', '--text-max-len=100', '--test', '--datapath=../video']
    ...
    checkpoint = torch.load(".\\..\\..\\FV2ES_TrainedModel\\models\\cmumosei_tav_Acc_0.7134_F1_0.4681_AUC_0.7356_imginvl500_seed0.pt", map_location='cpu')    # map_location='cuda:0'
